...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center px-4 sm:px-6 md:px-12 overflow-hidden bg-[#050505]">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start lg:items-center justify-between">
            ...
            <div className="flex-1">
              ...
              <motion.h1 
                ...
                className="text-4xl sm:text-[5.5rem] md:text-[6.5rem] lg:text-[7.5rem] font-black leading-[0.9] tracking-tighter text-white uppercase"
              >
                Fullstack <br />
              ...
              >
                <p className="text-gray-400 text-sm sm:text-base md:text-xl lg:text-2xl font-light leading-relaxed">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 mt-6 sm:mt-8">
                  <a href="#projects" className="relative group px-5 sm:px-8 py-3 sm:py-4 bg-emerald-500/10 border border-emerald-500/30 hover:border-emerald-400 hover:bg-emerald-500/20 rounded-none text-emerald-400 font-mono text-xs sm:text-sm uppercase tracking-widest transition-all">
                    <span className="relative z-10">View Projects</span>
                  </a>
                  <a href="https://github.com/Amine-Elbekari" target="_blank" rel="noopener noreferrer" className="px-5 sm:px-8 py-3 sm:py-4 border border-gray-800 hover:border-gray-600 rounded-none text-gray-400 hover:text-white font-mono text-xs sm:text-sm uppercase tracking-widest transition-colors flex items-center gap-3">
                  ...
                  {/* <a
                    href="/Myportfolio/Amine_ElBekari_CV.pdf"
                    target="_blank"
